 ...
 */
public class ShaderProgramMovie extends ShaderProgram {
     ...
     */
    public ShaderProgramMovie(OpenGLShader vertexShader, OpenGLShader fragmentShader) {
    ...
    protected void bindAttributes() {
        ...
        GLES20.glBindAttribLocation(shaderProgramHandle, 1, VertexShaderMovie.textureVectorString);
    }
    ...
    public int getTextureHandle() {
        return GLES20.glGetAttribLocation(shaderProgramHandle, VertexShaderMovie.textureVectorString);
    }
